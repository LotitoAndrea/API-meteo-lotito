...
function displayWeather(data) {
    const weatherDiv = document.getElementById('meteo');
            ...
            weatherHTML += `
                <div class="card mb-2">
                    <div class="card-body">
                        ...
                        <p class="card-text">Max: ${temperature_2m_max[i]}°C</p>
                        <p class="card-text">Min: ${temperature_2m_min[i]}°C</p>
                        <p class="card-text">Condizioni: ${getWeatherDescription(dailyWeatherCodes[i])} <img id="icone" src="icons/${getWeatherIcon(dailyWeatherCodes[i])}" alt="Icona meteo"></p>
                    </div>
                </div>
            `;
        }
